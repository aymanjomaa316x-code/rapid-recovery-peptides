  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Australia's trusted source for premium peptides. Lab-tested quality. Fast, discreet shipping."
        />
        <meta property="og:title" content="Rapid Recovery Peptides" />
        <meta
          property="og:description"
          content="Premium research peptides — lab-tested. Fast shipping in Australia."
        />
      </Head>
      ...
      >
          ...
          <div className="mx-auto max-w-6xl px-4">
            <div className="flex items-center justify-between py-5">
              <a href="/" className="flex items-center gap-3">
                <img
                  src="/logo.png"
                  alt="Rapid Recovery Peptides"
                  className="h-10 w-auto"
                />
              </a>
              <nav className="hidden gap-8 md:flex text-neutral-200">
                <a href="/" className="no-underline hover:text-[#D8B85A]">
                  Homepage
                </a>
                <a href="/products" className="no-underline hover:text-[#D8B85A]">
                  Products
                </a>
                <a href="/contact" className="no-underline hover:text-[#D8B85A]">
                  Contact
                </a>
                <a
                  href="/cart"
                  className="no-underline rounded-full border px-4 py-1 hover:text-[#D8B85A]"
                  style={{ borderColor: colors.goldDark }}
                >
                  Cart
                </a>
              </nav>
        ...
        <section className="w-full">
          <div className="mx-auto max-w-6xl px-4 py-12 text-center">
            ...
            <img
              ...
              className="mx-auto mt-6 mb-4 w-[320px] md:w-[520px]"
            />
        ...
        <section className="w-full">
          <div className="mx-auto max-w-6xl px-4 pt-10 text-center isolate">
            {/* Bottle banner above products (220px max width) */}
            <img
              src="/products/banner.png"
              alt="Rapid Recovery Peptides bottle"
              className="mx-auto h-auto object-contain max-w-[220px]"
            />

            <h2
              className="text-5xl font-semibold mb-8 mt-8"
              style={{
                backgroundImage: `linear-gradient(90deg, ${colors.goldLight}, ${colors.goldDark})`,
                WebkitBackgroundClip: "text",
                color: "transparent",
        ...
        <footer className="w-full mt-10 border-t border-neutral-900/80">
          <div className="mx-auto max-w-6xl px-4 py-10 text-center">
            ...
            <ul className="mt-4 space-y-1 text-sm" style={{ color: colors.goldLight }}>
              ...
              <li>
                <a href="/returns" className="hover:opacity-90">
                  Returns & Shipping
                </a>
              </li>
            </ul>
            <p className="mt-8 text-xs leading-relaxed" style={{ color: colors.goldLight }}>
              Disclaimer: Products are sold for laboratory research and development purposes only.
              Not for human consumption, medical, veterinary, or household use. No statements on
              this site have been evaluated by the TGA. By purchasing, you agree to our Terms &
              Conditions.
            </p>
            <p className="mt-4 text-xs" style={{ color: colors.goldLight }}>

  ...
  return (
    <div className="min-h-screen text-white" style={{ backgroundColor: colors.black }}>
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 opacity-[0.06]" style={{
        backgroundImage: "radial-gradient(1500px 600px at -10% -10%, rgba(216,184,90,0.25), rgba(0,0,0,0)), radial-gradient(1200px 500px at 110% 110%, rgba(184,144,46,0.25), rgba(0,0,0,0))",
      }}/>
      ...
      <header className="relative">
        <div className="mx-auto max-w-6xl px-4">
          <div className="flex items-center justify-between py-5">
            ...
            <nav className="hidden gap-8 md:flex text-neutral-200">
              <style>{`.navlink{color:#e5e7eb}.navlink:hover{color:#D8B85A}`}</style>
              <a href="/" className="navlink">Homepage</a>
              <a href="/products" className="navlink">Products</a>
              <a href="/contact" className="navlink">Contact</a>
              <a href="/cart" className="navlink rounded-full border px-4 py-1" style={{ borderColor: colors.goldDark }}>Cart</a>
            </nav>
          </div>
        </div>
      </header>
      ...
      <section className="relative text-center">
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-20">
          <h1 className="text-6xl font-bold tracking-tight sm:text-7xl md:text-8xl" style={{
            backgroundImage: `linear-gradient(90deg, ${colors.goldLight}, ${colors.goldDark})`,
            WebkitBackgroundClip: "text",
            color: "transparent",
          }}>Recover faster. Train harder.</h1>
          <p className="mt-6 text-2xl text-neutral-200 md:text-3xl">Australia's trusted source for premium peptides. Lab-tested. Fast shipping.</p>
          <div className="mt-8">
      ...
      {/* Featured Products with banner above */}
      <section className="relative">
        <div className="mx-auto max-w-6xl px-4 pt-10 text-center isolate">
          <img src="/products/banner.png" alt="Rapid Recovery Peptides bottle" className="mx-auto h-auto object-contain mix-blend-multiply max-w-[180px] md:max-w-[220px]" style={{ background: "transparent" }} />
          <h2 className="text-5xl font-semibold mb-8 mt-8" style={{backgroundImage:`linear-gradient(90deg, ${colors.goldLight}, ${colors.goldDark})`, WebkitBackgroundClip:'text', color:'transparent'}}>Featured Products</h2>
      ...
      <footer className="relative mt-10 border-t border-neutral-900/80">
        <div className="mx-auto max-w-6xl px-4 py-10 text-center">
          ...
          <p className="mt-8 text-xs leading-relaxed" style={{ color: colors.goldLight }}>Disclaimer: Products are sold for laboratory research and development purposes only. Not for human consumption, medical, veterinary, or household use. No statements on this site have been evaluated by the TGA. By purchasing, you agree to our Terms & Conditions.</p>
